...
using L01P02_2021_YD_650.Models;

namespace L01P02_2021_YD_650.Controllers
{
    public class materiasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,materia1,unidadesValorativas,estado")] materias materias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,materia1,unidadesValorativas,estado")] materias materias)
        {
            if (id != materias.id)
            {
                return NotFound();
